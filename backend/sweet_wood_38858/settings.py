"""
Django settings for sweet_wood_38858 project.
...
ROOT_URLCONF = 'sweet_wood_38858.urls'
...
WSGI_APPLICATION = 'sweet_wood_38858.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_wood_38858 API",
    "DESCRIPTION": "API documentation for sweet_wood_38858 App",
    "VERSION": "v1",
}
